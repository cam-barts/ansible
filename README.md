...
| `deploy_node_exporter.yml` | Pis + Arch hosts | Installs and enables `prometheus-node-exporter` from the distro repo. Branches on `ansible_os_family` for apt vs pacman. |
